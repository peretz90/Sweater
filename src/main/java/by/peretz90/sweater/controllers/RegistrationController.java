...
import by.peretz90.sweater.domain.dto.CaptchaResponseDto;
...
public class RegistrationController {
  ...
  public String addUser(
    ...
    if (isConfirmEmpty) {
      model.addAttribute("password2Error", "Password confirmation cannot be error");
    }
    if (user.getPassword() != null && !user.getPassword().equals(passwordConfirmation)) {
      model.addAttribute("passwordError", "Passvord are different!");
      return "registration";
    }
